	...
	return {
		open: function(_images, startImage, _options) {
			options = $extend({
				...
				imageFadeDuration: 600,			// Duration of the image fade-in animation (in milliseconds)
				captionAnimationDuration: 600,		// Duration of the caption animation (in milliseconds)
